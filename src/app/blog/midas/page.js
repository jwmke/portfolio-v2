                    ...
                    <div className='mx-auto pt-8 md:px-20'>
                        <div className='text-white text-left sm:mx-5 mb-8'>
                            ...
                            <div className='md:text-xl space-y-5 mt-8'>
                                ...
                                <p>For some, the automobile is a strong contender for the worst technology ever made. The first cars were created with good intentions – to allow for more freedom by solving the convenience pitfalls of horse-drawn carriages. Not soon after, urban planners began to prioritize the existence of cars over the experience of humans by introducing the idea of suburbs and expanding the footprints of cities to include streets wherever feasible.</p>
                                <div className='flex justify-center'>
                                ...
                                <p>You might not be convinced that modern luddites have deviated from their archetype, and therefore you’ll continue to view them as cynics against all technology, aka technophobes. But, consider a fungophobe – someone who fears all mushrooms and wants nothing to do with them. On the other hand, consider a fungophile – someone who is intensely interested in mushrooms and analytical about their properties, taste, toxicity, etc.</p>
                                <div className='flex justify-center'>
                                ...
                                <p>The lens of techno-traditionalism isn't about wholesale rejection of modernity, but rather about maintaining a spiritual and intellectual sovereignty in the face of accelerating change. When Evola wrote about "riding the tiger" – a metaphor he used to describe living in modern times – he wasn't advocating for complete withdrawal from society, but rather for maintaining inner detachment while engaging with modernity on one's own terms.</p>
                                ...
                                <p>While virtual/augmented reality is already quite far along in adoption, it hasn’t come anywhere near the threshold of evil it’s capable of. If current technological trends keep up, in the not so far future, a Three Class Society might emerge – where anyone can choose to drop out of society and live in their padded wirehead cage for the rest of their days.</p>
